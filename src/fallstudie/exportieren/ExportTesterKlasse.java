...
public class ExportTesterKlasse {
	...
	/**
	 * @author Angelos, Philipp Testerklasse für den Export.
	 */
	public static void main(String[] args) throws IOException,
			COSVisitorException, IllegalArgumentException, PrinterException {
		String[][] content = { { "1", "b", "1", "D" }, { "2", "b", "1", "D" },
				{ "3", "b", "1", "D" }, { "4", "b", "1", "D" },
				{ "5", "b", "1", "D" }, { "6", "b", "1", "D" },
				{ "7", "b", "1", "D" }, { "8", "b", "1", "D" },
				{ "9", "b", "1", "D" }, { "10", "b", "1", "D" },
		...
		String[] ueberschriften = { "1", "2", "3", "4", "5", "6", "7", "7",
				"7", "7", "7" };
		...
		// Aufruf des CSV-Exports
		CSVExport.exportCSV(content, ueberschriften);
		// Aufruf des PDF-Exports
