...
public class LayoutMitarbeiter extends JPanel implements View{
	...
	public LayoutMitarbeiter() {
		...
		T_Vorname.setBounds(190, 12, 300, 30);
		add(T_Vorname);
		...
		T_Nachname.setBounds(190, 53, 300, 30);
		add(T_Nachname);
		...
		T_Benutzername.setBounds(190, 94, 300, 30);
		add(T_Benutzername);
